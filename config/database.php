	...
	*/
	...
	'connections' => [
		...
		'mysql' => [
			...
			'database'  => env('DB_DATABASE', env('OPENSHIFT_APP_NAME', 'dannieqa')),
			'username'  => env('DB_USERNAME', env('OPENSHIFT_MYSQL_DB_USERNAME', 'adminAxgbJjc')),
			'password'  => env('DB_PASSWORD', env('OPENSHIFT_MYSQL_DB_PASSWORD', ' 396aApC_Wapx')),
			'charset'   => 'utf8',
